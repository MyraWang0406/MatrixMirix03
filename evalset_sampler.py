...
# 英文 motivation_bucket -> 中文 StrategyCard 枚举
_MB_MAP = {
    "deal_discount": "省钱", "compare": "省钱", "gift": "省钱",
    "pain_relief": "体验", "convenience": "更省事", "social_proof": "口碑",
    "premium_quality": "品质", "boredom": "爽感", "competition": "成就感",
    "collection": "收集", "social": "社交", "immersion": "体验", "reward": "成就感",
}
